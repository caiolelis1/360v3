...
CREATE TABLE `systems` (
  ...
  `nameSystem` varchar(45) NOT NULL,
  PRIMARY KEY (`idSystem`),
  UNIQUE KEY `id_UNIQUE` (`idSystem`)
...
INSERT INTO `systems` VALUES (1,'Administração'),(2,'Elétrica'),(3,'Mecânica');
...
-- Dump completed on 2023-03-23 10:52:59
